      ...
      <div className=''>
        {
          cartData.map((item, index) => {
            ...
            return (
              <div key={index} className='py-6 border-t border-gray-300 border-b text-gray-700 grid grid-cols-[4fr_0.5fr_0.5fr] sm:grid-cols-[4fr_2fr_0.5fr] items-center gap-4'>
